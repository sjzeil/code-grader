...
public class TestTAPOracle {
    ...
    @Test
    void testTAPOracle() throws FileNotFoundException {
        Oracle oracle = new TAPOracle(new OracleProperties(), testCase,
                sub, stage);
        ...
        String observed = 
            ...
            "# UnitTest: passed 6 out of 8 tests, for a success rate of 75.0%\n"
            ;
